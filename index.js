    ...
    compiler.plugin('emit', (compilation, callback) => {
      ...
      if (_this.options && Object.keys(_this.options).length && !_this.options.product) {
        ...
        array.forEach(item => {
          ...
          let varhtml = ''
          if (_this.options.speed && _this.options.exception) {
            varhtml = `
            <script src='https://s.waimai.baidu.com/xin/static/perf/dev/deploy.js'></script>          
            <script>          
              window.wmlogConfig = {
                ...
                'exception': ${_this.options.exception}
              }
            </script>
            </head>
            `
          } else if (!_this.options.speed && _this.options.exception) {
            varhtml = `
            <script src='https://s.waimai.baidu.com/xin/static/perf/dev/deploy.js'></script>          
            <script>          
              window.wmlogConfig = {
